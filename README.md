...
2. Open a shell with chezmoi and git
    - `nix shell nixpkgs#chezmoi nixpkgs#git -c "chezmoi init --apply https://github.com/carterworks/dotfiles.git"`
    - `nix-shell -p chezmoi git --command "chezmoi init --apply https://github.com/carterworks/dotfiles.git"` for older systems
