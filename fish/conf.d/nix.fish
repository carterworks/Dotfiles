#!/usr/bin/env fish
# --8<-- [This file is automatically generated from /Users/cmcbride/.nix-profile/etc/profile.d/nix.sh, do not edit] ---
if test -n "$HOME" ; and test -n "$USER" ;
    for d in $PATH; if test -e $d; set __savedpath $__savedpath $d; end; end;
    set -xg PATH /nix/store/jis165izlxngpgvv2anhz34lvkbdqfnl-coreutils-8.29/bin
