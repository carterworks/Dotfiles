...
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp proto completion debug apply resume generate-ts help" -f -a "exec" -d 'Run Codex non-interactively'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp proto completion debug apply resume generate-ts help" -f -a "login" -d 'Manage login'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp proto completion debug apply resume generate-ts help" -f -a "logout" -d 'Remove stored authentication credentials'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp proto completion debug apply resume generate-ts help" -f -a "mcp" -d '[experimental] Run Codex as an MCP server and manage MCP servers'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp proto completion debug apply resume generate-ts help" -f -a "proto" -d 'Run the Protocol stream via stdin/stdout'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp proto completion debug apply resume generate-ts help" -f -a "completion" -d 'Generate shell completion scripts'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp proto completion debug apply resume generate-ts help" -f -a "debug" -d 'Internal debugging commands'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp proto completion debug apply resume generate-ts help" -f -a "apply" -d 'Apply the latest diff produced by Codex agent as a `git apply` to your local working tree'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp proto completion debug apply resume generate-ts help" -f -a "resume" -d 'Resume a previous interactive session (picker by default; use --last to continue the most recent)'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp proto completion debug apply resume generate-ts help" -f -a "generate-ts" -d 'Internal: generate TypeScript protocol bindings'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp proto completion debug apply resume generate-ts help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
